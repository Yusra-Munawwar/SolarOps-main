...
var b = (0, import_react15.memo)(function(t10) {
  var o5, n7 = t10.position, r7 = t10.anchor, e11 = t10.children, l4 = Et(), u3 = Zr(), p5 = u3.animate, f4 = u3.config, b5 = Gt(), g5 = b5[0], w4 = b5[1], T4 = (0, import_react15.useRef)(false), C7 = void 0, E4 = false, P4 = w4.width > 0 && w4.height > 0, j4 = Math.round(n7[0]), N3 = Math.round(n7[1]);
  P4 && ("top" === r7 ? (j4 -= w4.width / 2, N3 -= w4.height + 14) : "right" === r7 ? (j4 += 14, N3 -= w4.height / 2) : "bottom" === r7 ? (j4 -= w4.width / 2, N3 += 14) : "left" === r7 ? (j4 -= w4.width + 14, N3 -= w4.height / 2) : "center" === r7 && (j4 -= w4.width / 2, N3 -= w4.height / 2), C7 = { transform: m(j4, N3) }, T4.current || (E4 = true), T4.current = [j4, N3]);
  var O5 = useSpring({ to: C7, config: f4, immediate: !p5 || E4 }), V3 = v({}, x, l4.tooltip, { transform: null != (o5 = O5.transform) ? o5 : m(j4, N3) });
...
function bisector_default(f4) {
  ...
  function right(a6, x6, lo, hi2) {
    ...
    while (lo < hi2) {
      const mid = lo + hi2 >>> 1;
      if (compare(a6[mid], x6) > 0) hi2 = mid;
      else lo = mid + 1;
    }
    return lo;
  }
...
function ticks_default(start2, stop2, count2) {
  ...
  if (reverse2 = stop2 < start2) n7 = start2, start2 = stop2, stop2 = n7;
  ...
  if (step > 0) {
    ...
    while (++i6 < n7) ticks[i6] = (r0 + i6) * step;
  } else {
    step = -step;
    let r0 = Math.round(start2 * step), r1 = Math.round(stop2 * step);
    if (r0 / step < start2) ++r0;
...
function hslConvert(o5) {
  ...
  if (s5) {
    if (r7 === max3) h3 = (g5 - b5) / s5 + (g5 < b5) * 6;
    else if (g5 === max3) h3 = (b5 - r7) / s5 + 2;
    else h3 = (r7 - g5) / s5 + 4;
...
define_default(Cubehelix, cubehelix2, extend(Color, {
  ...
  rgb: function() {
    var h3 = isNaN(this.h) ? 0 : (this.h + 120) * radians, l4 = +this.l, a6 = isNaN(this.s) ? 0 : this.s * l4 * (1 - l4), cosh3 = Math.cos(h3), sinh3 = Math.sin(h3);
    return new Rgb(
      255 * (l4 + a6 * (A2 * cosh3 + B * sinh3)),
      255 * (l4 + a6 * (C2 * cosh3 + D * sinh3)),
      255 * (l4 + a6 * (E2 * cosh3)),
      this.opacity
    );
  }
...
function hue(a6, b5) {
  var d3 = b5 - a6;
  return d3 ? linear(a6, d3 > 180 || d3 < -180 ? d3 - 360 * Math.round(d3 / 360) : d3) : constant_default2(isNaN(a6) ? b5 : a6);
}
function gamma(y4) {
  return (y4 = +y4) === 1 ? nogamma : function(a6, b5) {
    return b5 - a6 ? exponential(a6, b5, y4) : constant_default2(isNaN(a6) ? b5 : a6);
  };
}
function nogamma(a6, b5) {
  var d3 = b5 - a6;
  return d3 ? linear(a6, d3) : constant_default2(isNaN(a6) ? b5 : a6);
}
...
var rgb_default = function rgbGamma(y4) {
  ...
  function rgb5(start2, end) {
    var r7 = color3((start2 = rgb3(start2)).r, (end = rgb3(end)).r), g5 = color3(start2.g, end.g), b5 = color3(start2.b, end.b), opacity = nogamma(start2.opacity, end.opacity);
    return function(t10) {
      start2.r = r7(t10);
      start2.g = g5(t10);
      start2.b = b5(t10);
...
function rgbSpline(spline) {
  return function(colors3) {
    var n7 = colors3.length, r7 = new Array(n7), g5 = new Array(n7), b5 = new Array(n7), i6, color3;
    for (i6 = 0; i6 < n7; ++i6) {
      color3 = rgb3(colors3[i6]);
      r7[i6] = color3.r || 0;
      g5[i6] = color3.g || 0;
      b5[i6] = color3.b || 0;
    }
...
function numberArray_default(a6, b5) {
  ...
  return function(t10) {
    for (i6 = 0; i6 < n7; ++i6) c11[i6] = a6[i6] * (1 - t10) + b5[i6] * t10;
    return c11;
  };
}
...
function genericArray(a6, b5) {
  ...
  for (i6 = 0; i6 < na; ++i6) x6[i6] = value_default(a6[i6], b5[i6]);
  for (; i6 < nb; ++i6) c11[i6] = b5[i6];
  return function(t10) {
    for (i6 = 0; i6 < na; ++i6) c11[i6] = x6[i6](t10);
    return c11;
  };
}
...
function number_default2(a6, b5) {
  return a6 = +a6, b5 = +b5, function(t10) {
...
function object_default(a6, b5) {
  ...
  for (k6 in b5) {
    if (k6 in a6) {
      i6[k6] = value_default(a6[k6], b5[k6]);
    } else {
      c11[k6] = b5[k6];
    }
  }
  return function(t10) {
    for (k6 in i6) c11[k6] = i6[k6](t10);
    return c11;
  };
}
...
function string_default2(a6, b5) {
  ...
  while ((am = reA.exec(a6)) && (bm = reB.exec(b5))) {
    ...
    if ((am = am[0]) === (bm = bm[0])) {
      ...
      s5[++i6] = null;
      q.push({ i: i6, x: number_default2(am, bm) });
    }
    bi2 = reB.lastIndex;
  }
  if (bi2 < b5.length) {
  ...
  return s5.length < 2 ? q[0] ? one(q[0].x) : zero(b5) : (b5 = q.length, function(t10) {
    for (var i7 = 0, o5; i7 < b5; ++i7) s5[(o5 = q[i7]).i] = o5.x(t10);
    return s5.join("");
  });
}
...
function value_default(a6, b5) {
  ...
  return b5 == null || t10 === "boolean" ? constant_default2(b5) : (t10 === "number" ? number_default2 : t10 === "string" ? (c11 = color(b5)) ? (b5 = c11, rgb_default) : string_default2 : b5 instanceof color ? rgb_default : b5 instanceof Date ? date_default : isNumberArray(b5) ? numberArray_default : Array.isArray(b5) ? genericArray : typeof b5.valueOf !== "function" && typeof b5.toString !== "function" || isNaN(b5) ? object_default : number_default2)(a6, b5);
}
...
function decompose_default(a6, b5, c11, d3, e11, f4) {
  ...
  if (skewX = a6 * c11 + b5 * d3) c11 -= a6 * skewX, d3 -= b5 * skewX;
  if (scaleY = Math.sqrt(c11 * c11 + d3 * d3)) c11 /= scaleY, d3 /= scaleY, skewX /= scaleY;
  if (a6 * d3 < b5 * c11) a6 = -a6, b5 = -b5, skewX = -skewX, scaleX = -scaleX;
  return {
    translateX: e11,
    translateY: f4,
...
function interpolateTransform(parse, pxComma, pxParen, degParen) {
  ...
  function translate(xa, ya, xb, yb, s5, q) {
    if (xa !== xb || ya !== yb) {
      ...
      q.push({ i: i6 - 4, x: number_default2(xa, xb) }, { i: i6 - 2, x: number_default2(ya, yb) });
    } else if (xb || yb) {
  ...
  function rotate(a6, b5, s5, q) {
    if (a6 !== b5) {
      ...
      q.push({ i: s5.push(pop(s5) + "rotate(", null, degParen) - 2, x: number_default2(a6, b5) });
    } else if (b5) {
  ...
  function skewX(a6, b5, s5, q) {
    if (a6 !== b5) {
      q.push({ i: s5.push(pop(s5) + "skewX(", null, degParen) - 2, x: number_default2(a6, b5) });
    } else if (b5) {
  ...
  return function(a6, b5) {
    ...
    return function(t10) {
      ...
      while (++i6 < n7) s5[(o5 = q[i6]).i] = o5.x(t10);
      return s5.join("");
    };
  };
}
...
function hsl3(hue3) {
  return function(start2, end) {
    var h3 = hue3((start2 = hsl2(start2)).h, (end = hsl2(end)).h), s5 = nogamma(start2.s, end.s), l4 = nogamma(start2.l, end.l), opacity = nogamma(start2.opacity, end.opacity);
    return function(t10) {
      start2.h = h3(t10);
      start2.s = s5(t10);
      start2.l = l4(t10);
...
function hcl2(hue3) {
  return function(start2, end) {
    var h3 = hue3((start2 = hcl(start2)).h, (end = hcl(end)).h), c11 = nogamma(start2.c, end.c), l4 = nogamma(start2.l, end.l), opacity = nogamma(start2.opacity, end.opacity);
    return function(t10) {
      start2.h = h3(t10);
      start2.c = c11(t10);
      start2.l = l4(t10);
...
function cubehelix3(hue3) {
  return function cubehelixGamma(y4) {
    ...
    function cubehelix6(start2, end) {
      var h3 = hue3((start2 = cubehelix2(start2)).h, (end = cubehelix2(end)).h), s5 = nogamma(start2.s, end.s), l4 = nogamma(start2.l, end.l), opacity = nogamma(start2.opacity, end.opacity);
      return function(t10) {
        start2.h = h3(t10);
        start2.s = s5(t10);
...
function transformer() {
  ...
  function rescale() {
    ...
    piecewise3 = n7 > 2 ? polymap : bimap;
    output = input = null;
    return scale;
  }
  function scale(x6) {
    return x6 == null || isNaN(x6 = +x6) ? unknown : (output || (output = piecewise3(domain.map(transform), range, interpolate2)))(transform(clamp2(x6)));
  }
  ...
  scale.rangeRound = function(_2) {
    return range = Array.from(_2), interpolate2 = round_default, rescale();
  };
...
function loggish(transform) {
  ...
  scale.ticks = function(count2) {
    ...
    if (!(base % 1) && j4 - i6 < n7) {
      ...
      if (z4.length * 2 < n7) z4 = ticks_default(u3, v6, n7);
    } else {
...
var millisecond = newInterval2(function() {
}, function(date2, step) {
...
millisecond.every = function(k6) {
  k6 = Math.floor(k6);
  if (!isFinite(k6) || !(k6 > 0)) return null;
  if (!(k6 > 1)) return millisecond;
  return newInterval2(function(date2) {
...
var millisecond_default2 = millisecond;
...
var second = newInterval2(function(date2) {
...
var second_default2 = second;
var seconds = second.range;

// node_modules/d3-scale/node_modules/d3-time/src/minute.js
var minute = newInterval2(function(date2) {
...
var minute_default2 = minute;
var minutes = minute.range;

// node_modules/d3-scale/node_modules/d3-time/src/hour.js
var hour = newInterval2(function(date2) {
...
var sunday2 = weekday(0);
var monday2 = weekday(1);
var tuesday2 = weekday(2);
var wednesday2 = weekday(3);
var thursday2 = weekday(4);
var friday2 = weekday(5);
var saturday2 = weekday(6);
...
var month = newInterval2(function(date2) {
  date2.setDate(1);
  date2.setHours(0, 0, 0, 0);
}, function(date2, step) {
...
var month_default2 = month;
var months = month.range;

// node_modules/d3-scale/node_modules/d3-time/src/year.js
var year = newInterval2(function(date2) {
  date2.setMonth(0, 1);
  date2.setHours(0, 0, 0, 0);
}, function(date2, step) {
...
var year_default2 = year;
var years = year.range;

// node_modules/d3-scale/node_modules/d3-time/src/utcMinute.js
var utcMinute = newInterval2(function(date2) {
...
var utcMinute_default2 = utcMinute;
var utcMinutes = utcMinute.range;

// node_modules/d3-scale/node_modules/d3-time/src/utcHour.js
var utcHour = newInterval2(function(date2) {
...
var utcHour_default2 = utcHour;
var utcHours = utcHour.range;

// node_modules/d3-scale/node_modules/d3-time/src/utcDay.js
var utcDay = newInterval2(function(date2) {
...
var utcSunday2 = utcWeekday(0);
var utcMonday2 = utcWeekday(1);
var utcTuesday2 = utcWeekday(2);
var utcWednesday2 = utcWeekday(3);
var utcThursday2 = utcWeekday(4);
var utcFriday2 = utcWeekday(5);
var utcSaturday2 = utcWeekday(6);
...
var utcMonth = newInterval2(function(date2) {
  date2.setUTCDate(1);
  date2.setUTCHours(0, 0, 0, 0);
}, function(date2, step) {
...
var utcMonth_default2 = utcMonth;
var utcMonths = utcMonth.range;

// node_modules/d3-scale/node_modules/d3-time/src/utcYear.js
var utcYear = newInterval2(function(date2) {
...
var utcYear_default2 = utcYear;
var utcYears = utcYear.range;

// node_modules/d3-scale/node_modules/d3-time/src/ticks.js
function ticker(year2, month2, week, day2, hour2, minute2) {
  const tickIntervals = [
    [second_default2, 1, durationSecond],
    [second_default2, 5, 5 * durationSecond],
    [second_default2, 15, 15 * durationSecond],
    [second_default2, 30, 30 * durationSecond],
  ...
  function tickInterval(start2, stop2, count2) {
    ...
    if (i6 === 0) return millisecond_default2.every(Math.max(tickStep(start2, stop2, count2), 1));
    const [t10, step] = tickIntervals[target / tickIntervals[i6 - 1][2] < tickIntervals[i6][2] / target ? i6 - 1 : i6];
    return t10.every(step);
  }
  return [ticks, tickInterval];
}
var [utcTicks, utcTickInterval] = ticker(utcYear_default2, utcMonth_default2, utcSunday2, utcDay_default, utcHour_default2, utcMinute_default2);
var [timeTicks, timeTickInterval] = ticker(year_default2, month_default2, sunday2, day_default, hour_default2, minute_default2);
...
function time() {
  return initRange.apply(calendar(timeTicks, timeTickInterval, year_default2, month_default2, sunday2, day_default, hour_default2, minute_default2, second_default2, timeFormat).domain([new Date(2e3, 0, 1), new Date(2e3, 0, 2)]), arguments);
}

// node_modules/d3-scale/src/utcTime.js
function utcTime() {
  return initRange.apply(calendar(utcTicks, utcTickInterval, utcYear_default2, utcMonth_default2, utcSunday2, utcDay_default, utcHour_default2, utcMinute_default2, second_default2, utcFormat).domain([Date.UTC(2e3, 0, 1), Date.UTC(2e3, 0, 2)]), arguments);
}
...
function line_default() {
  ...
  function line(data) {
    ...
    for (i6 = 0; i6 <= n7; ++i6) {
      ...
      if (defined0) output.point(+x6(d3, i6, data), +y4(d3, i6, data));
    }
...
function area_default() {
  var x0 = x2, x1 = null, y0 = constant_default3(0), y1 = y2, defined = constant_default3(true), context = null, curve = linear_default, output = null;
  function area(data) {
  ...
  area.x = function(_2) {
    return arguments.length ? (x0 = typeof _2 === "function" ? _2 : constant_default3(+_2), x1 = null, area) : x0;
  };
  area.x0 = function(_2) {
    return arguments.length ? (x0 = typeof _2 === "function" ? _2 : constant_default3(+_2), area) : x0;
  };
  area.x1 = function(_2) {
    return arguments.length ? (x1 = _2 == null ? null : typeof _2 === "function" ? _2 : constant_default3(+_2), area) : x1;
  };
  area.y = function(_2) {
    return arguments.length ? (y0 = typeof _2 === "function" ? _2 : constant_default3(+_2), y1 = null, area) : y0;
  };
  area.y0 = function(_2) {
    return arguments.length ? (y0 = typeof _2 === "function" ? _2 : constant_default3(+_2), area) : y0;
  };
  area.y1 = function(_2) {
    return arguments.length ? (y1 = _2 == null ? null : typeof _2 === "function" ? _2 : constant_default3(+_2), area) : y1;
  };
  ...
  area.defined = function(_2) {
    return arguments.length ? (defined = typeof _2 === "function" ? _2 : constant_default3(!!_2), area) : defined;
  };
...
function controlPoints(x6) {
  ...
  for (i6 = 1; i6 < n7 - 1; ++i6) a6[i6] = 1, b5[i6] = 4, r7[i6] = 4 * x6[i6] + 2 * x6[i6 + 1];
  a6[n7 - 1] = 2, b5[n7 - 1] = 7, r7[n7 - 1] = 8 * x6[n7 - 1] + x6[n7];
  for (i6 = 1; i6 < n7; ++i6) m4 = a6[i6] / b5[i6 - 1], b5[i6] -= m4, r7[i6] -= m4 * r7[i6 - 1];
  a6[n7 - 1] = r7[n7 - 1] / b5[n7 - 1];
  for (i6 = n7 - 2; i6 >= 0; --i6) a6[i6] = (r7[i6] - a6[i6 + 1]) / b5[i6];
  b5[n7 - 1] = (x6[n7] + a6[n7 - 1]) / 2;
  for (i6 = 0; i6 < n7 - 1; ++i6) b5[i6] = 2 * x6[i6 + 1] - a6[i6 + 1];
  return [a6, b5];
}
...
function expand_default(series, order) {
  ...
  for (var i6, n7, j4 = 0, m4 = series[0].length, y4; j4 < m4; ++j4) {
    for (y4 = i6 = 0; i6 < n7; ++i6) y4 += series[i6][j4][1] || 0;
    if (y4) for (i6 = 0; i6 < n7; ++i6) series[i6][j4][1] /= y4;
  }
...
function silhouette_default(series, order) {
  ...
  for (var j4 = 0, s0 = series[order[0]], n7, m4 = s0.length; j4 < m4; ++j4) {
    for (var i6 = 0, y4 = 0; i6 < n7; ++i6) y4 += series[i6][j4][1] || 0;
...
function peak(series) {
  ...
  while (++i6 < n7) if ((vi2 = +series[i6][1]) > vj) vj = vi2, j4 = i6;
  return j4;
}
...
function Sr() {
  return Sr = Object.assign ? Object.assign.bind() : function(e11) {
    for (var r7 = 1; r7 < arguments.length; r7++) {
      ...
      for (var i6 in t10) Object.prototype.hasOwnProperty.call(t10, i6) && (e11[i6] = t10[i6]);
    }
    return e11;
...
function jr(e11, r7) {
  ...
  for (i6 = 0; i6 < o5.length; i6++) t10 = o5[i6], r7.indexOf(t10) >= 0 || (n7[t10] = e11[t10]);
  return n7;
}
...
var mt = function(e11) {
  if (!ut[e11]) throw new TypeError("'" + e11 + "', is not a valid curve interpolator identifier.");
  return ut[e11];
};
  ...
  return e11.length && r7.length && (u3 = [].concat(e11), r7.forEach(function(r8) {
    for (var i7 = function() {
      ...
      if (Xi(s6, r8, o5)) {
        ...
        if (f4) {
          if (Ui.includes(f4.type)) if ("inherit" === f4.background || "inherit" === f4.color) {
          ...
          } else (0, import_set2.default)(r8, d3, "url(#" + a7 + ")");
...
function rgbConvert2(o5) {
  if (!(o5 instanceof Color2)) o5 = color2(o5);
  if (!o5) return new Rgb2();
  o5 = o5.rgb();
...
function hslConvert2(o5) {
  if (o5 instanceof Hsl2) return new Hsl2(o5.h, o5.s, o5.l, o5.opacity);
  if (!(o5 instanceof Color2)) o5 = color2(o5);
  if (!o5) return new Hsl2();
  if (o5 instanceof Hsl2) return o5;
  o5 = o5.rgb();
  var r7 = o5.r / 255, g5 = o5.g / 255, b5 = o5.b / 255, min3 = Math.min(r7, g5, b5), max3 = Math.max(r7, g5, b5), h3 = NaN, s5 = max3 - min3, l4 = (max3 + min3) / 2;
  if (s5) {
    if (r7 === max3) h3 = (g5 - b5) / s5 + (g5 < b5) * 6;
...
function labConvert2(o5) {
  if (o5 instanceof Lab2) return new Lab2(o5.l, o5.a, o5.b, o5.opacity);
  if (o5 instanceof Hcl2) return hcl2lab2(o5);
  if (!(o5 instanceof Rgb2)) o5 = rgbConvert2(o5);
...
function xyz2lab2(t10) {
  return t10 > t32 ? Math.pow(t10, 1 / 3) : t10 / t22 + t03;
}
function lab2xyz2(t10) {
  return t10 > t13 ? t10 * t10 * t10 : t22 * (t10 - t03);
}
...
function hclConvert2(o5) {
  if (o5 instanceof Hcl2) return new Hcl2(o5.h, o5.c, o5.l, o5.opacity);
  if (!(o5 instanceof Lab2)) o5 = labConvert2(o5);
  if (o5.a === 0 && o5.b === 0) return new Hcl2(NaN, 0 < o5.l && o5.l < 100 ? 0 : NaN, o5.l, o5.opacity);
...
function hcl2lab2(o5) {
  if (isNaN(o5.h)) return new Lab2(o5.l, 0, 0, o5.opacity);
...
function cubehelixConvert2(o5) {
  if (o5 instanceof Cubehelix2) return new Cubehelix2(o5.h, o5.s, o5.l, o5.opacity);
  if (!(o5 instanceof Rgb2)) o5 = rgbConvert2(o5);
  var r7 = o5.r / 255, g5 = o5.g / 255, b5 = o5.b / 255, l4 = (BC_DA2 * b5 + ED2 * r7 - EB2 * g5) / (BC_DA2 + ED2 - EB2), bl = b5 - l4, k6 = (E3 * (g5 - l4) - C4 * bl) / D2, s5 = Math.sqrt(k6 * k6 + bl * bl) / (E3 * l4 * (1 - l4)), h3 = s5 ? Math.atan2(k6, bl) * degrees3 - 120 : NaN;
  return new Cubehelix2(h3 < 0 ? h3 + 360 : h3, s5, l4, o5.opacity);
}
function cubehelix4(h3, s5, l4, opacity) {
...
define_default2(Cubehelix2, cubehelix4, extend2(Color2, {
  ...
  rgb: function() {
    var h3 = isNaN(this.h) ? 0 : (this.h + 120) * radians2, l4 = +this.l, a6 = isNaN(this.s) ? 0 : this.s * l4 * (1 - l4), cosh3 = Math.cos(h3), sinh3 = Math.sin(h3);
    return new Rgb2(
      255 * (l4 + a6 * (A3 * cosh3 + B2 * sinh3)),
      255 * (l4 + a6 * (C4 * cosh3 + D2 * sinh3)),
      255 * (l4 + a6 * (E3 * cosh3)),
      this.opacity
    );
  }
...
function hue2(a6, b5) {
  var d3 = b5 - a6;
  return d3 ? linear3(a6, d3 > 180 || d3 < -180 ? d3 - 360 * Math.round(d3 / 360) : d3) : constant_default4(isNaN(a6) ? b5 : a6);
}
function gamma2(y4) {
  return (y4 = +y4) === 1 ? nogamma2 : function(a6, b5) {
    return b5 - a6 ? exponential2(a6, b5, y4) : constant_default4(isNaN(a6) ? b5 : a6);
  };
}
function nogamma2(a6, b5) {
  var d3 = b5 - a6;
  return d3 ? linear3(a6, d3) : constant_default4(isNaN(a6) ? b5 : a6);
}
...
var rgb_default2 = function rgbGamma2(y4) {
  ...
  function rgb5(start2, end) {
    var r7 = color3((start2 = rgb4(start2)).r, (end = rgb4(end)).r), g5 = color3(start2.g, end.g), b5 = color3(start2.b, end.b), opacity = nogamma2(start2.opacity, end.opacity);
    return function(t10) {
      start2.r = r7(t10);
      start2.g = g5(t10);
      start2.b = b5(t10);
...
function hsl5(hue3) {
  return function(start2, end) {
    var h3 = hue3((start2 = hsl4(start2)).h, (end = hsl4(end)).h), s5 = nogamma2(start2.s, end.s), l4 = nogamma2(start2.l, end.l), opacity = nogamma2(start2.opacity, end.opacity);
    return function(t10) {
      start2.h = h3(t10);
      start2.s = s5(t10);
      start2.l = l4(t10);
...
function hcl4(hue3) {
  return function(start2, end) {
    var h3 = hue3((start2 = hcl3(start2)).h, (end = hcl3(end)).h), c11 = nogamma2(start2.c, end.c), l4 = nogamma2(start2.l, end.l), opacity = nogamma2(start2.opacity, end.opacity);
    return function(t10) {
      start2.h = h3(t10);
      start2.c = c11(t10);
      start2.l = l4(t10);
...
function cubehelix5(hue3) {
  return function cubehelixGamma(y4) {
    y4 = +y4;
    function cubehelix6(start2, end) {
      var h3 = hue3((start2 = cubehelix4(start2)).h, (end = cubehelix4(end)).h), s5 = nogamma2(start2.s, end.s), l4 = nogamma2(start2.l, end.l), opacity = nogamma2(start2.opacity, end.opacity);
      return function(t10) {
        start2.h = h3(t10);
        start2.s = s5(t10);
        start2.l = l4(Math.pow(t10, y4));
...
var K3 = { millisecond: [], second: J.slice(0, 1), minute: J.slice(0, 2), hour: J.slice(0, 3), day: J.slice(0, 4), month: J.slice(0, 5), year: J.slice(0, 6) };
var L = function(n7) {
  return function(t10) {
    return K3[n7].forEach(function(n8) {
      n8(t10);
    }), t10;
  };
};
...
var W2 = function(n7, t10, r7, e11) {
  ...
  var T4 = linear2().rangeRound("x" === e11 ? [0, r7] : [r7, 0]).domain(p5 ? [o5, a6] : [a6, o5]).clamp(g5);
...
var ln = function(a6, i6, o5, u3) {
  ...
  if ("linear" === o5.type) a6.forEach(function(n7) {
...
var hn = { millisecond: [millisecond_default, millisecond_default], second: [second_default, second_default], minute: [minute_default, utcMinute_default], hour: [hour_default, utcHour_default], day: [newInterval(function(n7) {
...
var b2 = function(t10) {
  ...
  return { ticks: x6.map(function(t11) {
    var i7 = "string" == typeof t11 ? function(t14) {
      ...
      return f4 && f4 > 0 && e12 > f4 ? "" + String(t14).slice(0, f4).concat("...") : "" + t14;
    }(t11) : t11;
...
var S = (0, import_react18.memo)(function(t10) {
  var e11, n7 = t10.value, r7 = t10.format, o5 = t10.lineX, l4 = t10.lineY, s5 = t10.onClick, f4 = t10.textBaseline, u3 = t10.textAnchor, d3 = t10.animatedProps, x6 = Et(), m4 = x6.axis.ticks.line, y4 = x6.axis.ticks.text, k6 = null != (e11 = null == r7 ? void 0 : r7(n7)) ? e11 : n7, v6 = (0, import_react18.useMemo)(function() {
    ...
    return s5 ? { style: p2({}, t11, { cursor: "pointer" }), onClick: function(t14) {
      return s5(t14, k6);
    } } : { style: t11 };
  }, [d3.opacity, s5, k6]);
...
var A4 = function(e11) {
  var r7 = e11.axis, o5 = e11.scale, s5 = e11.x, d3 = void 0 === s5 ? 0 : s5, x6 = e11.y, m4 = void 0 === x6 ? 0 : x6, y4 = e11.length, v6 = e11.ticksPosition, P4 = e11.tickValues, A5 = e11.tickSize, W4 = void 0 === A5 ? 5 : A5, O5 = e11.tickPadding, w4 = void 0 === O5 ? 5 : O5, B5 = e11.tickRotation, X4 = void 0 === B5 ? 0 : B5, Y4 = e11.format, C7 = e11.renderTick, z4 = void 0 === C7 ? S : C7, V3 = e11.truncateTickAt, j4 = e11.legend, D4 = e11.legendPosition, R = void 0 === D4 ? "end" : D4, E4 = e11.legendOffset, L2 = void 0 === E4 ? 0 : E4, q = e11.onClick, F2 = e11.ariaHidden, H2 = Et(), N3 = H2.axis.legend.text, I = (0, import_react18.useMemo)(function() {
    return T2(Y4, o5);
  }, [Y4, o5]), J2 = b2({ axis: r7, scale: o5, ticksPosition: v6, tickValues: P4, tickSize: W4, tickPadding: w4, tickRotation: X4, truncateTickAt: V3 }), G = J2.ticks, K5 = J2.textAlign, M2 = J2.textBaseline, Q3 = null;
  if (void 0 !== j4) {
    var U, Z = 0, $2 = 0, _2 = 0;
  ...
  return (0, import_jsx_runtime3.jsxs)(animated.g, { transform: nt.transform, "aria-hidden": F2, children: [at(function(e12, i6, n7, r8) {
    return t6.createElement(z4, p2({ tickIndex: r8, format: I, rotate: X4, textBaseline: M2, textAnchor: K5, truncateTickAt: V3, animatedProps: e12 }, i6, q ? { onClick: q } : {}));
  }), (0, import_jsx_runtime3.jsx)(animated.line, { style: H2.axis.domain.line, x1: 0, x2: nt.lineX2, y1: 0, y2: nt.lineY2 }), Q3] });
};
var W3 = (0, import_react18.memo)(A4);
...
var X2 = (0, import_react18.memo)(function(t10) {
  ...
  return (0, import_jsx_runtime3.jsx)(import_jsx_runtime3.Fragment, { children: B3.map(function(t11) {
    var a6 = o5[t11];
    if (!a6) return null;
...
var C5 = (0, import_react18.memo)(function(t10) {
...
var z3 = (0, import_react18.memo)(function(t10) {
  ...
  return (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [s5 && (0, import_jsx_runtime3.jsx)(C5, { lines: s5 }), c11 && (0, import_jsx_runtime3.jsx)(C5, { lines: c11 })] });
});
var V2 = function(t10, e11) {
  var i6, n7 = e11.axis, r7 = e11.scale, o5 = e11.x, a6 = void 0 === o5 ? 0 : o5, l4 = e11.y, c11 = void 0 === l4 ? 0 : l4, f4 = e11.length, u3 = e11.ticksPosition, d3 = e11.tickValues, x6 = e11.tickSize, m4 = void 0 === x6 ? 5 : x6, y4 = e11.tickPadding, h3 = void 0 === y4 ? 5 : y4, g5 = e11.tickRotation, k6 = void 0 === g5 ? 0 : g5, v6 = e11.format, p5 = e11.legend, T4 = e11.legendPosition, P4 = void 0 === T4 ? "end" : T4, S3 = e11.legendOffset, A5 = void 0 === S3 ? 0 : S3, W4 = e11.theme, O5 = b2({ axis: n7, scale: r7, ticksPosition: u3, tickValues: d3, tickSize: m4, tickPadding: h3, tickRotation: k6, engine: "canvas" }), w4 = O5.ticks, B5 = O5.textAlign, X4 = O5.textBaseline;
  t10.save(), t10.translate(a6, c11), t10.textAlign = B5, t10.textBaseline = X4;
  ...
  var C7 = "function" == typeof v6 ? v6 : function(t11) {
    return "" + t11;
  };
  if (w4.forEach(function(e12) {
    ...
    var z4 = 0, V3 = 0, j4 = 0, D4 = "center";
    "y" === n7 ? (j4 = -90, z4 = A5, "start" === P4 ? (D4 = "start", V3 = f4) : "middle" === P4 ? (D4 = "center", V3 = f4 / 2) : "end" === P4 && (D4 = "end")) : (V3 = A5, "start" === P4 ? D4 = "start" : "middle" === P4 ? (D4 = "center", z4 = f4 / 2) : "end" === P4 && (D4 = "end", z4 = f4)), t10.translate(z4, V3), t10.rotate(ni(j4)), t10.font = (W4.axis.legend.text.fontWeight ? W4.axis.legend.text.fontWeight + " " : "") + W4.axis.legend.text.fontSize + "px " + W4.axis.legend.text.fontFamily, W4.axis.legend.text.fill && (t10.fillStyle = W4.axis.legend.text.fill), t10.textAlign = D4, t10.textBaseline = "middle", t10.fillText(p5, 0, 0);
  }
  t10.restore();
};
...
var B4 = function(i6) {
  var n7, r7, l4, c11, h3, g5, m4, f4, u3, v6, y4, b5 = i6.x, k6 = i6.y, x6 = i6.width, A5 = i6.height, W4 = i6.data, O5 = i6.direction, z4 = void 0 === O5 ? "left-to-right" : O5, B5 = i6.justify, w4 = void 0 !== B5 && B5, X4 = i6.textColor, Y4 = i6.background, H2 = void 0 === Y4 ? "transparent" : Y4, E4 = i6.opacity, j4 = void 0 === E4 ? 1 : E4, T4 = i6.symbolShape, L2 = void 0 === T4 ? "square" : T4, M2 = i6.symbolSize, F2 = void 0 === M2 ? 16 : M2, P4 = i6.symbolSpacing, R = void 0 === P4 ? 8 : P4, q = i6.symbolBorderWidth, V3 = void 0 === q ? 0 : q, D4 = i6.symbolBorderColor, G = void 0 === D4 ? "transparent" : D4, I = i6.onClick, N3 = i6.onMouseEnter, _2 = i6.onMouseLeave, J2 = i6.toggleSerie, K5 = i6.effects, Q3 = (0, import_react19.useState)({}), U = Q3[0], Z = Q3[1], $2 = Et(), tt = (0, import_react19.useCallback)(function(t10) {
    if (K5) {
      var e11 = K5.filter(function(t11) {
        return "hover" === t11.on;
    ...
    null == N3 || N3(W4, t10);
  }, [N3, W4, K5]), et2 = (0, import_react19.useCallback)(function(t10) {
    if (K5) {
      var e11 = K5.filter(function(t11) {
        return "hover" !== t11.on;
      }).reduce(function(t11, e12) {
    ...
    null == _2 || _2(W4, t10);
  }, [_2, W4, K5]), it2 = S2({ direction: z4, justify: w4, symbolSize: null != (n7 = U.symbolSize) ? n7 : F2, symbolSpacing: R, width: x6, height: A5 }), nt = it2.symbolX, ot = it2.symbolY, rt2 = it2.labelX, lt = it2.labelY, at = it2.labelAnchor, ct2 = it2.labelAlignment, st = [I, N3, _2, J2].some(function(t10) {
    return void 0 !== t10;
  }), dt2 = "function" == typeof L2 ? L2 : C6[L2];
  return (0, import_jsx_runtime4.jsxs)("g", { transform: "translate(" + b5 + "," + k6 + ")", style: { opacity: null != (r7 = U.itemOpacity) ? r7 : j4 }, children: [(0, import_jsx_runtime4.jsx)("rect", { width: x6, height: A5, fill: null != (l4 = U.itemBackground) ? l4 : H2, style: { cursor: st ? "pointer" : "auto" }, onClick: function(t10) {
...
var w3 = function(e11) {
  var i6 = e11.data, n7 = e11.x, o5 = e11.y, r7 = e11.direction, l4 = e11.padding, a6 = void 0 === l4 ? 0 : l4, c11 = e11.justify, s5 = e11.effects, d3 = e11.itemWidth, h3 = e11.itemHeight, g5 = e11.itemDirection, m4 = void 0 === g5 ? "left-to-right" : g5, f4 = e11.itemsSpacing, u3 = void 0 === f4 ? 0 : f4, v6 = e11.itemTextColor, p5 = e11.itemBackground, y4 = void 0 === p5 ? "transparent" : p5, b5 = e11.itemOpacity, x6 = void 0 === b5 ? 1 : b5, S3 = e11.symbolShape, A5 = e11.symbolSize, W4 = e11.symbolSpacing, O5 = e11.symbolBorderWidth, z4 = e11.symbolBorderColor, C7 = e11.onClick, w4 = e11.onMouseEnter, X4 = e11.onMouseLeave, Y4 = e11.toggleSerie, H2 = k4({ itemCount: i6.length, itemWidth: d3, itemHeight: h3, itemsSpacing: u3, direction: r7, padding: a6 }).padding, E4 = "row" === r7 ? d3 + u3 : 0, j4 = "column" === r7 ? h3 + u3 : 0;
  return (0, import_jsx_runtime4.jsx)("g", { transform: "translate(" + n7 + "," + o5 + ")", children: i6.map(function(e12, i7) {
    return (0, import_jsx_runtime4.jsx)(B4, { data: e12, x: i7 * E4 + H2.left, y: i7 * j4 + H2.top, width: d3, height: h3, direction: m4, justify: c11, effects: s5, textColor: v6, background: y4, opacity: x6, symbolShape: S3, symbolSize: A5, symbolSpacing: W4, symbolBorderWidth: O5, symbolBorderColor: z4, onClick: C7, onMouseEnter: w4, onMouseLeave: X4, toggleSerie: Y4 }, i7);
  }) });
};
var X3 = function(e11) {
  var i6 = e11.data, n7 = e11.containerWidth, o5 = e11.containerHeight, r7 = e11.translateX, l4 = void 0 === r7 ? 0 : r7, a6 = e11.translateY, c11 = void 0 === a6 ? 0 : a6, s5 = e11.anchor, d3 = e11.direction, h3 = e11.padding, g5 = void 0 === h3 ? 0 : h3, m4 = e11.justify, f4 = e11.itemsSpacing, u3 = void 0 === f4 ? 0 : f4, v6 = e11.itemWidth, p5 = e11.itemHeight, y4 = e11.itemDirection, b5 = e11.itemTextColor, S3 = e11.itemBackground, A5 = e11.itemOpacity, W4 = e11.symbolShape, O5 = e11.symbolSize, z4 = e11.symbolSpacing, C7 = e11.symbolBorderWidth, B5 = e11.symbolBorderColor, X4 = e11.onClick, Y4 = e11.onMouseEnter, H2 = e11.onMouseLeave, E4 = e11.toggleSerie, j4 = e11.effects, T4 = k4({ itemCount: i6.length, itemsSpacing: u3, itemWidth: v6, itemHeight: p5, direction: d3, padding: g5 }), L2 = T4.width, M2 = T4.height, F2 = x4({ anchor: s5, translateX: l4, translateY: c11, containerWidth: n7, containerHeight: o5, width: L2, height: M2 }), P4 = F2.x, R = F2.y;
  return (0, import_jsx_runtime4.jsx)(w3, { data: i6, x: P4, y: R, direction: d3, padding: g5, justify: m4, effects: j4, itemsSpacing: u3, itemWidth: v6, itemHeight: p5, itemDirection: y4, itemTextColor: b5, itemBackground: S3, itemOpacity: A5, symbolShape: W4, symbolSize: O5, symbolSpacing: z4, symbolBorderWidth: C7, symbolBorderColor: B5, onClick: X4, onMouseEnter: Y4, onMouseLeave: H2, toggleSerie: "boolean" == typeof E4 ? void 0 : E4 });
};
var Y3 = { start: "left", middle: "center", end: "right" };
var H = function(t10, e11) {
  var i6 = e11.data, n7 = e11.containerWidth, o5 = e11.containerHeight, r7 = e11.translateX, l4 = void 0 === r7 ? 0 : r7, a6 = e11.translateY, c11 = void 0 === a6 ? 0 : a6, s5 = e11.anchor, d3 = e11.direction, h3 = e11.padding, g5 = void 0 === h3 ? 0 : h3, m4 = e11.justify, f4 = void 0 !== m4 && m4, u3 = e11.itemsSpacing, v6 = void 0 === u3 ? 0 : u3, p5 = e11.itemWidth, y4 = e11.itemHeight, b5 = e11.itemDirection, A5 = void 0 === b5 ? "left-to-right" : b5, W4 = e11.itemTextColor, O5 = e11.symbolSize, z4 = void 0 === O5 ? 16 : O5, C7 = e11.symbolSpacing, B5 = void 0 === C7 ? 8 : C7, w4 = e11.theme, X4 = k4({ itemCount: i6.length, itemWidth: p5, itemHeight: y4, itemsSpacing: v6, direction: d3, padding: g5 }), H2 = X4.width, E4 = X4.height, j4 = X4.padding, T4 = x4({ anchor: s5, translateX: l4, translateY: c11, containerWidth: n7, containerHeight: o5, width: H2, height: E4 }), L2 = T4.x, M2 = T4.y, F2 = "row" === d3 ? p5 + v6 : 0, P4 = "column" === d3 ? y4 + v6 : 0;
  t10.save(), t10.translate(L2, M2), t10.font = w4.legends.text.fontSize + "px " + (w4.legends.text.fontFamily || "sans-serif"), i6.forEach(function(e12, i7) {
    var n8, o6, r8 = i7 * F2 + j4.left, l5 = i7 * P4 + j4.top, a7 = S2({ direction: A5, justify: f4, symbolSize: z4, symbolSpacing: B5, width: p5, height: y4 }), c12 = a7.symbolX, s6 = a7.symbolY, d4 = a7.labelX, h4 = a7.labelY, g6 = a7.labelAnchor, m5 = a7.labelAlignment;
...
var Delaunator = class _Delaunator {
  ...
  update() {
    ...
    for (let k6 = 0, xp, yp; k6 < this._ids.length; k6++) {
      ...
      const x6 = coords[2 * i6];
      const y4 = coords[2 * i6 + 1];
      if (k6 > 0 && Math.abs(x6 - xp) <= EPSILON && Math.abs(y4 - yp) <= EPSILON) continue;
      xp = x6;
      yp = y4;
...
var Voronoi = class {
  ...
  _init() {
    ...
    for (let i6 = 0, j4 = 0, n7 = triangles.length, x6, y4; i6 < n7; i6 += 3, j4 += 2) {
      ...
      const t23 = triangles[i6 + 1] * 2;
      const t33 = triangles[i6 + 2] * 2;
  ...
  render(context) {
    ...
    for (let i6 = 0; i6 < hull.length; ++i6) {
      ...
      if (p5) this._renderSegment(x6, y4, p5[0], p5[1], context);
    }
  ...
  *cellPolygons() {
  ...
  contains(i6, x6, y4) {
    if ((x6 = +x6, x6 !== x6) || (y4 = +y4, y4 !== y4)) return false;
    return this.delaunay._step(i6, x6, y4) === i6;
  }
  *neighbors(i6) {
    const ci = this._clip(i6);
    if (ci) for (const j4 of this.delaunay.neighbors(i6)) {
  ...
  _clipSegment(x0, y0, x1, y1, c0, c12) {
    while (true) {
      if (c0 === 0 && c12 === 0) return [x0, y0, x1, y1];
      if (c0 & c12) return null;
      let x6, y4, c11 = c0 || c12;
      if (c11 & 8) x6 = x0 + (x1 - x0) * (this.ymax - y0) / (y1 - y0), y4 = this.ymax;
      else if (c11 & 4) x6 = x0 + (x1 - x0) * (this.ymin - y0) / (y1 - y0), y4 = this.ymin;
      else if (c11 & 2) y4 = y0 + (y1 - y0) * (this.xmax - x0) / (x1 - x0), x6 = this.xmax;
      else y4 = y0 + (y1 - y0) * (this.xmin - x0) / (x1 - x0), x6 = this.xmin;
      if (c0) x0 = x6, y0 = y4, c0 = this._regioncode(x0, y0);
      else x1 = x6, y1 = y4, c12 = this._regioncode(x1, y1);
    }
  }
  _clipInfinite(i6, points, vx0, vy0, vxn, vyn) {
    let P4 = Array.from(points), p5;
    if (p5 = this._project(P4[0], P4[1], vx0, vy0)) P4.unshift(p5[0], p5[1]);
    if (p5 = this._project(P4[P4.length - 2], P4[P4.length - 1], vxn, vyn)) P4.push(p5[0], p5[1]);
    if (P4 = this._clipFinite(i6, P4)) {
      for (let j4 = 0, n7 = P4.length, c0, c12 = this._edgecode(P4[n7 - 2], P4[n7 - 1]); j4 < n7; j4 += 2) {
        ...
        if (c0 && c12) j4 = this._edge(i6, c0, c12, P4, j4), n7 = P4.length;
      }
    } else if (this.contains(i6, (this.xmin + this.xmax) / 2, (this.ymin + this.ymax) / 2)) {
  ...
  _project(x0, y0, vx, vy) {
    ...
    if (vy < 0) {
      ...
      if ((c11 = (this.ymin - y0) / vy) < t10) y4 = this.ymin, x6 = x0 + (t10 = c11) * vx;
    } else if (vy > 0) {
      if (y0 >= this.ymax) return null;
      if ((c11 = (this.ymax - y0) / vy) < t10) y4 = this.ymax, x6 = x0 + (t10 = c11) * vx;
    }
    if (vx > 0) {
      if (x0 >= this.xmax) return null;
      if ((c11 = (this.xmax - x0) / vx) < t10) x6 = this.xmax, y4 = y0 + (t10 = c11) * vy;
    } else if (vx < 0) {
      if (x0 <= this.xmin) return null;
      if ((c11 = (this.xmin - x0) / vx) < t10) x6 = this.xmin, y4 = y0 + (t10 = c11) * vy;
    }
    return [x6, y4];
  }
  _edgecode(x6, y4) {
...
var Delaunay = class _Delaunay {
  ...
  _init() {
    ...
    for (let e11 = 0, n7 = halfedges.length; e11 < n7; ++e11) {
      ...
      if (halfedges[e11] === -1 || inedges[p5] === -1) inedges[p5] = e11;
    }
  ...
  *neighbors(i6) {
    ...
    if (collinear2) {
      ...
      if (l4 > 0) yield collinear2[l4 - 1];
      if (l4 < collinear2.length - 1) yield collinear2[l4 + 1];
      return;
    }
    const e0 = inedges[i6];
    if (e0 === -1) return;
  ...
  find(x6, y4, i6 = 0) {
    if ((x6 = +x6, x6 !== x6) || (y4 = +y4, y4 !== y4)) return -1;
    const i0 = i6;
    let c11;
    while ((c11 = this._step(i6, x6, y4)) >= 0 && c11 !== i6 && c11 !== i0) i6 = c11;
    return c11;
  }
  _step(i6, x6, y4) {
    ...
    do {
      ...
      if (e11 === -1) {
        ...
        if (e11 !== t10) {
          if (pow2(x6 - points[e11 * 2], 2) + pow2(y4 - points[e11 * 2 + 1], 2) < dc) return e11;
        }
        break;
      }
    } while (e11 !== e0);
...
var O4 = function(e11) {
  var i6 = e11.nodes, l4 = e11.width, u3 = e11.height, a6 = e11.x, d3 = e11.y, c11 = e11.onMouseEnter, h3 = e11.onMouseMove, m4 = e11.onMouseLeave, y4 = e11.onClick, g5 = e11.debug, b5 = (0, import_react20.useRef)(null), k6 = (0, import_react20.useState)(null), C7 = k6[0], L2 = k6[1], w4 = x5({ points: i6, x: a6, y: d3, width: l4, height: u3, debug: g5 }), W4 = w4.delaunay, D4 = w4.voronoi, M2 = (0, import_react20.useMemo)(function() {
    if (g5 && D4) return D4.render();
  }, [g5, D4]), O5 = (0, import_react20.useCallback)(function(n7) {
    if (!b5.current) return [null, null];
    ...
    if (L2(null), m4) {
      var e12 = void 0;
      null !== C7 && (e12 = i6[C7]), e12 && m4(e12, n7);
    }
  }, [L2, C7, m4, i6]), z4 = (0, import_react20.useCallback)(function(n7) {
    var e12 = O5(n7), i7 = e12[0], o5 = e12[1];
    L2(i7), o5 && (null == y4 || y4(o5, n7));
  }, [O5, L2, y4]);
  return (0, import_jsx_runtime5.jsxs)("g", { ref: b5, children: [g5 && D4 && (0, import_jsx_runtime5.jsxs)(import_jsx_runtime5.Fragment, { children: [(0, import_jsx_runtime5.jsx)("path", { d: M2, stroke: "red", strokeWidth: 1, opacity: 0.75 }), null !== C7 && (0, import_jsx_runtime5.jsx)("path", { fill: "pink", opacity: 0.35, d: D4.renderCell(C7) })] }), (0, import_jsx_runtime5.jsx)("rect", { width: l4, height: u3, fill: "red", opacity: 0, style: { cursor: "auto" }, onMouseEnter: P4, onMouseMove: j4, onMouseLeave: S3, onClick: z4 })] });
};
...
// node_modules/@nivo/line/dist/nivo-line.es.js
function re() {
  return re = Object.assign ? Object.assign.bind() : function(e11) {
    for (var i6 = 1; i6 < arguments.length; i6++) {
      var r7 = arguments[i6];
      for (var n7 in r7) Object.prototype.hasOwnProperty.call(r7, n7) && (e11[n7] = r7[n7]);
    }
    return e11;
...
var le = re({}, se, { enablePointLabel: import_prop_types5.default.bool.isRequired, role: import_prop_types5.default.string.isRequired, useMesh: import_prop_types5.default.bool.isRequired }, Jr, yt);
var ue = re({ pixelRatio: import_prop_types5.default.number.isRequired }, se);
...
var be = function(e11) {
  var o5 = e11.data, t10 = e11.xScale, a6 = void 0 === t10 ? ce.xScale : t10, s5 = e11.xFormat, l4 = e11.yScale, d3 = void 0 === l4 ? ce.yScale : l4, c11 = e11.yFormat, f4 = e11.width, p5 = e11.height, h3 = e11.colors, b5 = void 0 === h3 ? ce.colors : h3, g5 = e11.curve, m4 = void 0 === g5 ? ce.curve : g5, v6 = e11.areaBaselineValue, x6 = void 0 === v6 ? ce.areaBaselineValue : v6, R = e11.pointColor, q = void 0 === R ? ce.pointColor : R, O5 = e11.pointBorderColor, M2 = void 0 === O5 ? ce.pointBorderColor : O5, C7 = e11.enableSlices, S3 = void 0 === C7 ? ce.enableSlicesTooltip : C7, T4 = Dt(s5), w4 = Dt(c11), L2 = pr(b5, "id"), W4 = Et(), G = We(q, W4), P4 = We(M2, W4), E4 = (0, import_react21.useState)([]), j4 = E4[0], F2 = E4[1], V3 = (0, import_react21.useMemo)(function() {
    ...
    return { legendData: e12.map(function(e13) {
      return re({}, e13, { hidden: !i6.find(function(i7) {
        return i7.id === e13.id;
      }) });
    }).reverse(), series: i6 };
  }, [o5, X4, L2]), A5 = z4.legendData, H2 = z4.series, I = (0, import_react21.useCallback)(function(e12) {
    F2(function(i6) {
    ...
    return (0, import_react21.useMemo)(function() {
      return r7.reduce(function(e13, i6) {
        return [].concat(e13, i6.data.filter(function(e14) {
          ...
          return l5.color = n7(i6), l5.borderColor = o6(l5), l5.data = re({}, r8.data, { xFormatted: t11(r8.data.x), yFormatted: a7(r8.data.y) }), l5;
        }));
      }, []);
    }, [r7, n7, o6, t11, a7]);
  }({ series: H2, getPointColor: G, getPointBorderColor: P4, formatX: T4, formatY: w4 }), N3 = ye({ enableSlices: S3, points: K5, width: f4, height: p5 });
  return { legendData: A5, toggleSerie: I, lineGenerator: pe({ curve: m4 }), areaGenerator: he({ curve: m4, yScale: D4, areaBaselineValue: x6 }), getColor: L2, series: H2, xScale: Y4, yScale: D4, slices: N3, points: K5 };
};
var ge = function(e11) {
...
var me = function(e11) {
  ...
  return (0, import_jsx_runtime6.jsx)("g", { children: o5.map(function(e12) {
    return (0, import_jsx_runtime6.jsx)(ge, re({ path: i6(e12.data.map(function(e13) {
      return e13.position;
    })) }, re({ areaOpacity: r7, areaBlendMode: n7 }, e12)), e12.id);
  }) });
};
...
var Pe2 = function(e11) {
  return (0, import_jsx_runtime6.jsx)(Jt, { children: function(i6) {
    ...
    return (0, import_jsx_runtime6.jsx)(Ge2, re({ width: r7, height: n7 }, e11));
  } });
};
var Ee = function(e11) {
  var i6 = e11.width, t10 = e11.height, a6 = e11.margin, d3 = e11.pixelRatio, c11 = e11.data, f4 = e11.xScale, p5 = e11.xFormat, h3 = e11.yScale, y4 = e11.yFormat, b5 = e11.curve, g5 = e11.layers, m4 = e11.colors, v6 = e11.lineWidth, x6 = e11.enableArea, q = e11.areaBaselineValue, O5 = e11.areaOpacity, M2 = e11.enablePoints, C7 = e11.pointSize, w4 = e11.pointColor, k6 = e11.pointBorderWidth, B5 = e11.pointBorderColor, L2 = e11.enableGridX, W4 = e11.gridXValues, G = e11.enableGridY, j4 = e11.gridYValues, F2 = e11.axisTop, Y4 = e11.axisRight, D4 = e11.axisBottom, X4 = e11.axisLeft, A5 = e11.legends, H2 = e11.isInteractive, I = e11.debugMesh, J2 = e11.onMouseLeave, K5 = e11.onClick, Q3 = e11.tooltip, U = e11.canvasRef, Z = (0, import_react21.useRef)(null), $2 = Bt(i6, t10, a6), ne2 = $2.margin, oe2 = $2.innerWidth, te2 = $2.innerHeight, ae2 = $2.outerWidth, se2 = $2.outerHeight, le2 = Et(), ue2 = (0, import_react21.useState)(null), de2 = ue2[0], ce2 = ue2[1], fe2 = be({ data: c11, xScale: f4, xFormat: p5, yScale: h3, yFormat: y4, width: oe2, height: te2, colors: m4, curve: b5, areaBaselineValue: q, pointColor: w4, pointBorderColor: B5 }), pe2 = fe2.lineGenerator, he2 = fe2.areaGenerator, ye2 = fe2.series, ge2 = fe2.xScale, me2 = fe2.yScale, ve2 = fe2.points, xe2 = x5({ points: ve2, width: oe2, height: te2, debug: I }), Re3 = xe2.delaunay, qe3 = xe2.voronoi;
  (0, import_react21.useEffect)(function() {
    ...
    e12.scale(d3, d3), e12.fillStyle = le2.background, e12.fillRect(0, 0, ae2, se2), e12.translate(ne2.left, ne2.top), g5.forEach(function(i7) {
      if ("function" == typeof i7 && i7({ ctx: e12, innerWidth: oe2, innerHeight: te2, series: ye2, points: ve2, xScale: ge2, yScale: me2, lineWidth: v6, lineGenerator: pe2, areaGenerator: he2, currentPoint: de2, setCurrentPoint: ce2 }), "grid" === i7 && le2.grid.line.strokeWidth > 0 && (e12.lineWidth = le2.grid.line.strokeWidth, e12.strokeStyle = le2.grid.line.stroke, L2 && D3(e12, { width: oe2, height: te2, scale: ge2, axis: "x", values: W4 }), G && D3(e12, { width: oe2, height: te2, scale: me2, axis: "y", values: j4 })), "axes" === i7 && j2(e12, { xScale: ge2, yScale: me2, width: oe2, height: te2, top: F2, right: Y4, bottom: D4, left: X4, theme: le2 }), "areas" === i7 && true === x6 && (e12.save(), e12.globalAlpha = O5, he2.context(e12), ye2.forEach(function(i8) {
      ...
      })), "points" === i7 && true === M2 && C7 > 0 && ve2.forEach(function(i8) {
        e12.fillStyle = i8.color, e12.beginPath(), e12.arc(i8.x, i8.y, C7 / 2, 0, 2 * Math.PI), e12.fill(), k6 > 0 && (e12.strokeStyle = i8.borderColor, e12.lineWidth = k6, e12.stroke());
        ...
        A5.forEach(function(i8) {
          H(e12, re({}, i8, { data: i8.data || r7, containerWidth: oe2, containerHeight: te2, theme: le2 }));
        });
      }
    });
  }, [Z, ae2, se2, g5, le2, pe2, ye2, ge2, me2, L2, W4, G, j4, F2, Y4, D4, X4, A5, ve2, M2, C7, de2]);
  var Oe3 = (0, import_react21.useCallback)(function(e12) {
    var i7 = Fi(Z.current, e12), r7 = i7[0], n7 = i7[1];
    if (!Ai(ne2.left, ne2.top, oe2, te2, r7, n7)) return null;
...
var Fe2 = (0, import_react21.forwardRef)(function(e11, i6) {
  return (0, import_jsx_runtime6.jsx)(je2, re({}, e11, { canvasRef: i6 }));
});
var Ve2 = (0, import_react21.forwardRef)(function(e11, i6) {
  return (0, import_jsx_runtime6.jsx)(Jt, { children: function(r7) {
    ...
    return (0, import_jsx_runtime6.jsx)(Fe2, re({ width: n7, height: o5 }, e11, { ref: i6 }));
  } });
});
export {
  Ge2 as Line,
